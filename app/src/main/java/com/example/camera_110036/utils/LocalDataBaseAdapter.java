package com.example.camera_110036.utils;
...
import com.example.camera_110036.Fragments.LocalFragment;
import com.example.camera_110036.MainActivity;
...
public class LocalDataBaseAdapter extends RecyclerView.Adapter<LocalDataBaseAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.activity_local_database_items, null);
